...
export default function ReactFirebaseFileUpload  ()  {
  ...
  return (
     ...
     <table className="posicion">
      ...
      <img className="fotos" src={url || "https://upload.wikimedia.org/wikipedia/commons/4/42/Photo-camera-in-circular-outlined-interface-button.svg"} alt="firebase-image" />
      </div>
      </td>
<td className="tamano">
